...
/** Symbol cache
 */
 ol_style_Collaboratif.symbolCache = null;
 ...
 */
 ol_style_Collaboratif.getFeatureStyleFn = function(featureType, cache, options) {
  // Fonction de style
  if (!featureType) featureType = {};
  return function(feature) {
    // Chargement du cache des images
    ol_style_Collaboratif.loadSymbolCache();
    // Conditionnal style
    ...
    var fstyle = ol_style_Collaboratif.formatFeatureStyle (style, feature);
    ...
    olStyle.setStroke(ol_style_Collaboratif.Stroke (fstyle));
    return olStyle;
  }
};
